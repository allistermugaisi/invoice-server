...
@media only screen and (max-width: 600px) {
  ...
  invoice-link {
    ...
    <body>
      ...
      <div class"footer">
          <a href="https://sys-invoice.netlify.app">
          <img class="footer-logo" src="https://res.cloudinary.com/yugillc/image/upload/q_auto/v1638113693/invoice-sys_wubbkb.png"/>
        </a>
      </div>
    <p style="text-align: center">Make beautiful invoices</p>
    </div>
    </body>
</html>`;
}
